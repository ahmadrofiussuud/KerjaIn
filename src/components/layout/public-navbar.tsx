      ...
      <nav
        className={cn(
          ...
          isScrolled
            ...
            : "border-b border-slate-800/40 bg-slate-950/20 backdrop-blur-sm"
        )}
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-2.5 shrink-0">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-sky-600 text-white shadow-sm shadow-sky-900/30">
                    ...
                    className={cn(
                      ...
                      isActive
                        ? isScrolled
                          ...
                          : "text-sky-400 bg-sky-950/50 border border-sky-900/40"
                        : isScrolled
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Link
                href="/register"
                className="px-5 py-2 bg-sky-600 hover:bg-sky-500 text-white font-bold rounded-xl shadow-md shadow-sky-600/10 hover:shadow-lg hover:shadow-sky-500/20 hover:-translate-y-0.5 transition-all text-xs tracking-wide uppercase"
              >
                Daftar Gratis
              </Link>
            </div>
